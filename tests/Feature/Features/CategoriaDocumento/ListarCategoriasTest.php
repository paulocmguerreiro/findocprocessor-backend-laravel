...
it('navega para a página seguinte via cursor sem duplicados', function (): void {
    ...
    $pagina1 = $this->getJson('/api/categorias-documento?per_page=2&sort=nome')->assertOk();
    ...
    $pagina2 = $this->getJson('/api/categorias-documento?per_page=2&sort=nome&cursor='.$params['cursor'])->assertOk();
