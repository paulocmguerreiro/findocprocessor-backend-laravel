...
regras de uma única feature (máquina de estados unificada). A reconciliação de entidades por
lado (`RegraReconciliarEntidadesDocumento`) fica em `01-features/documento-pipeline.md` — não
