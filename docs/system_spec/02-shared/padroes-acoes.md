...
Exemplo: as transições intermédias do Documento (`MarcarAnaliseMalware`, `MarcarAnaliseTexto`, `MarcarAnaliseOcr`, `MarcarAnaliseIaLocal`, `MarcarAnaliseCloud`, `MarcarErro`, `MarcarPerigoso`) — ver `01-features/documento.md`.
