...
| Documento          | `01-features/documento.md`           | 17 (8 expostas via endpoint + 9 sem HTTP, só programáticas — 6 de transição + reivindicação #90 + triagem/scan malware #91 + recorder de extracção #94) | 8 REST |
...
| Componente                                                                                                                    | Ficheiro               |
| ----------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| Enums — partilhados (`TipoMovimento`, `DirecaoOrdenacao`, `EstadoDocumento`, `FiltroEstadoRegisto`, `PosicaoEmpresaMae`, `EtapaExtracao`, `ResultadoEtapa`) + feature-local (`ModoReprocessamento`, `CampoOrdenacaoDocumentos`) | `02-shared/enums.md`   |
...
| `ExtracaoDocumento` (dimensão de extracção 1-1 com `Documento`, #94) | `03-models/extracao-documento.md` |
