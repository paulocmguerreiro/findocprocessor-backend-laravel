...
final class ListarTiposDocumentoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort' => ['sometimes', 'string', Rule::in(array_column(CampoOrdenacaoTiposDocumento::cases(), 'value'))],
            'direction' => ['sometimes', 'string', Rule::in(array_column(DirecaoOrdenacao::cases(), 'value'))],
            'cursor' => ['sometimes', 'string'],
            'id_categoria' => ['sometimes', 'string', 'uuid', Rule::exists('categorias_documento', 'id')],
        ];
    }
